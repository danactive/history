...
for (const country of ['japan', 'usa', 'canada', 'mexico', 'italy', 'turkiye', 'spain', 'dominican-republic']) {
  ...
  for (const feature of data.features) {
    ...
    Object.assign(p, anchor(main), {
      abbreviation: ['japan', 'italy', 'turkiye', 'spain', 'dominican-republic'].includes(country) ? p.id : p.id.split('-')[1],
    })
  }
